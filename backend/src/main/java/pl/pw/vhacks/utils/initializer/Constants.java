...
public class Constants {
    ...
    public static final String question1 =  "Why [put name] wears a scarf on her head all time?";
    public static final String answer1 = "In some cultures, women traditionally wear different head covers. They do it from different reasons. For some women, it is a part of cultural heritage of their motherland. For some other, it is a duty they pay to their religion, or a symbol of their faith. It can be also just a matter of fashion. Unfortunately, sometimes women do not choose what they wear.";

    public static final String question2 = "Why they put the water on the little children in the church? They cry, why do they hurt them?";
    public static final String answer2 = "The children get baptised at this moment. It means that they are reborn as " +
    ...
    public static final String question3 = "Why don't all my friends go to our church?";
    public static final String answer3 = "We go to our church because we are Christians and here we can meet with God " +
    ...
    public static final String question4 = "Why [Muslim name] always refuses when I give him a burger?";
    ...
    public static final String question5 = "What [Muslim name] does here on this carpet? (praying)";
    public static final String answer5 = "This is a traditional way the Muslims pray. They are obligated to pray 5 times a day.\n" +
    ...
    public static final String question6 = "Is there a McDonald's in heaven?";
    ...
    public static final String answer7_path1 = "";
    public static final String answer7_path2 = "";
